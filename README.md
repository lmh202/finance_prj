...
* **Classical quantitative rules remain the primary decision maker.** Market direction is determined by transparent technical indicators and portfolio rules. AI components (e.g., HAR-X risk forecasting) provide additional evidence rather than replacing deterministic decision logic.
...
* The current prototype has been evaluated on historical data and demonstration portfolios, **but it has not undergone live-market deployment, regulatory certification, or comprehensive fairness and robustness audits.**
